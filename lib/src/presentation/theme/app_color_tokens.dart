...
class AppColorTokens extends ThemeExtension<AppColorTokens> {
  ...
  static const light = AppColorTokens(
    brand: BrandTokens(
      primary:      AppPrimitiveColors.brandPrimary,
      primaryHover: AppPrimitiveColors.brandPrimaryHover,
      primarySoft:  AppPrimitiveColors.brandPrimarySoftLight,
      primaryCta:   AppPrimitiveColors.brandPrimaryCta,
      secondary:    AppPrimitiveColors.brandSecondaryLight,
    ),
    status: StatusTokens(
      success:     AppPrimitiveColors.statusSuccess,
      successSoft: AppPrimitiveColors.statusSuccessSoftLight,
      warning:     AppPrimitiveColors.statusWarning,
      warningSoft: AppPrimitiveColors.statusWarningSoftLight,
      error:       AppPrimitiveColors.statusError,
    ...
    text: TextTokens(
      ...
      body:         AppPrimitiveColors.textPrimaryLight,
      primary:      AppPrimitiveColors.textPrimaryLight,
      secondary:    AppPrimitiveColors.textSecondaryLight,
      muted:        AppPrimitiveColors.textTertiaryLight,
      disabled:     AppPrimitiveColors.textDisabledLight,
      inverse:      AppPrimitiveColors.textInverseLight,
      link:         AppPrimitiveColors.textLink,
      income:       AppPrimitiveColors.textIncome,
      expense:      AppPrimitiveColors.textExpense,
      pending:      AppPrimitiveColors.textPending,
      error:        AppPrimitiveColors.textError,
      onPrimaryCta: AppPrimitiveColors.textOnPrimaryCta,
    ),
    bg: BgTokens(
      page:      AppPrimitiveColors.bgPageLight,
      base:      AppPrimitiveColors.bgBaseLight,
      subtle:    AppPrimitiveColors.bgSubtleLight,
      elevated:  AppPrimitiveColors.bgElevatedLight,
      brandSoft: AppPrimitiveColors.bgBrandSoftLight,
      overlay:   AppPrimitiveColors.bgOverlayLight,
    ),
    border: BorderTokens(
      defaultColor: AppPrimitiveColors.borderDefaultLight,
      divider:      AppPrimitiveColors.borderDividerLight,
      strong:       AppPrimitiveColors.borderStrongLight,
      focus:        AppPrimitiveColors.borderFocus,
    ),
  );
  ...
  static const dark = AppColorTokens(
    brand: BrandTokens(
      primary:      AppPrimitiveColors.brandPrimary,
      primaryHover: AppPrimitiveColors.brandPrimaryHover,
      primarySoft:  AppPrimitiveColors.brandPrimarySoftDark,
      primaryCta:   AppPrimitiveColors.brandPrimaryCta,
      secondary:    AppPrimitiveColors.brandSecondaryDark,
    ),
    status: StatusTokens(
      success:     AppPrimitiveColors.statusSuccess,
      successSoft: AppPrimitiveColors.statusSuccessSoftDark,
      warning:     AppPrimitiveColors.statusWarning,
      warningSoft: AppPrimitiveColors.statusWarningSoftDark,
      error:       AppPrimitiveColors.statusError,
      errorSoft:   AppPrimitiveColors.statusErrorSoftDark,
    ...
    text: TextTokens(
      ...
      primary:      AppPrimitiveColors.textPrimaryDark,
      secondary:    AppPrimitiveColors.textSecondaryDark,
      muted:        AppPrimitiveColors.textTertiaryDark,
      disabled:     AppPrimitiveColors.textDisabledDark,
      inverse:      AppPrimitiveColors.textInverseDark,
      link:         AppPrimitiveColors.textLink,
      income:       AppPrimitiveColors.textIncome,
      expense:      AppPrimitiveColors.textExpense,
      pending:      AppPrimitiveColors.textPending,
    ...
    bg: BgTokens(
      page:      AppPrimitiveColors.bgPageDark,
      base:      AppPrimitiveColors.bgBaseDark,
      subtle:    AppPrimitiveColors.bgSubtleDark,
      elevated:  AppPrimitiveColors.bgElevatedDark,
      brandSoft: AppPrimitiveColors.bgBrandSoftDark,
      overlay:   AppPrimitiveColors.bgOverlayDark,
    ),
    border: BorderTokens(
      defaultColor: AppPrimitiveColors.borderDefaultDark,
      divider:      AppPrimitiveColors.borderDividerDark,
      strong:       AppPrimitiveColors.borderStrongDark,
      focus:        AppPrimitiveColors.borderFocus,
    ),
  );
